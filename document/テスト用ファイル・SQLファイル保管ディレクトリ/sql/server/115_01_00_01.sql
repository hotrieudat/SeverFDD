...
INSERT INTO ldap_mst VALUES ('0002', 2, 'OpenLDAPテストデータ', '172.17.255.84', NULL, NULL, NULL, 389, 3, 'ou=people,dc=openldap,dc=local', 'sn/givenname', 'mail', NULL, 2, 'cn=admin,dc=openldap,dc=local', 'n00t9jaV', 2, '000001', '000001', '2018-11-05 10:45:35', NULL);
