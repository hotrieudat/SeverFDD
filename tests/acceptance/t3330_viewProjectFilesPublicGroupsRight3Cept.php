...
$I->checkSearch($I->headerButtons_forPublicGroups['right']['search']['xPath'], false, false, false);
$I->see($I->searchModalInformation_forPublicGroups['right']['word'], '//html/body/div[2]/div[2]/div[2]/div[2]/div/div[2]/div[2]/table/tbody/tr[2]/td[3]');
