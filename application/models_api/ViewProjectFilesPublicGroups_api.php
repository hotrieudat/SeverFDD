...
class ViewProjectFilesPublicGroups_API extends ExtModel
{
    protected $table = "view_project_files_public_groups";
    protected $primary_key = array("project_id", "file_id", "id", "type");
    protected $parent_key = array("project_id", "file_id");
