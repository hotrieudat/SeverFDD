...
class ProjectsFilesProjectsAuthorityGroups_api extends ExtModel
{
    protected $table = "projects_files_projects_authority_groups";
    protected $primary_key = array("project_id", "file_id", "authority_groups_id");
